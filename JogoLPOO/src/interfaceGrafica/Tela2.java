...
public class Tela2 extends JPanel {
    ...
    private ArrayList<Carta> deckP1; // Lista para armazenar o deck do jogador
     ...
     * Create the panel.
     */
    public Tela2(Janela frame, Jogador p1, Jogador p2) {
        setLayout(null);
        ...
        lblP1.setText("Jogador: " + p1.getNome());
        ...
        listCriaturas.addListSelectionListener(new ListSelectionListener() {
            public void valueChanged(ListSelectionEvent e) {
                if (!e.getValueIsAdjusting()) {
                    ...
                    if (index != -1 && deckP1.size() < maxCartas) {
                        deckP1.add(cc.getCriaturas().get(index));
        ...
        listFeiticos.addListSelectionListener(new ListSelectionListener() {
            public void valueChanged(ListSelectionEvent e) {
                if (!e.getValueIsAdjusting()) {
                    ...
                    if (index != -1 && deckP1.size() < maxCartas) {
                        deckP1.add(cc.getFeiticos().get(index));
        ...
        listEncantamentos.addListSelectionListener(new ListSelectionListener() {
            public void valueChanged(ListSelectionEvent e) {
                if (!e.getValueIsAdjusting()) {
                    ...
                    if (index != -1 && deckP1.size() < maxCartas) {
                        deckP1.add(cc.getEncantamentos().get(index));
        ...
        btnProximo.addActionListener(e -> {
            if (deckP1.size() == maxCartas) {
            	
            	p1.setDeck(deckP1);
            	
            	frame.setContentPane(new Tela3(frame, p1, p2));
				frame.revalidate();
				frame.repaint();
            }
        });
    ...
    private void atualizarDeckCount() {
        lblDeckCount.setText("Cartas no Deck: " + deckP1.size() + "/" + maxCartas);
